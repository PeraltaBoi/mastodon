...
class ButtonScrollList extends Component {
  ...
  handleMoveLeft = () => {
    this.setState(prevState => ({
      scrollPosition: prevState.scrollPosition - 100, // Adjust scroll amount as needed
    }));
  };
...
const {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'row', overflowX: 'hidden', whiteSpace: 'nowrap', position: 'relative' }}>
<button
        ...
        <div style={{ overflowX: 'scroll', whiteSpace: 'nowrap', position: 'relative', width: '300px' }}>
          <div style={{ display: 'flex', flexDirection: 'row', transform: `translateX(-${scrollPosition}px)`, transition: 'transform 0.3s ease' }}>
...
export default injectIntl(ButtonScrollList); */
...
class ButtonScrollableList extends Component {
  static propTypes = {
    children: PropTypes.node,
  ...
  render() {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'row', overflowX: 'hidden', whiteSpace: 'nowrap', position: 'relative' }}>
        ...
        <div style={{ overflowX: 'scroll', whiteSpace: 'nowrap', position: 'relative', width: '300px' }}>
          <div style={{ display: 'flex', flexDirection: 'row', overflow: 'hidden', transform: `translateX(-${scrollPosition}px)`, transition: 'transform 0.3s ease' }}>
...
export default injectIntl(ButtonScrollableList); */
...
class ButtonScrollableList extends PureComponent {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(ButtonScrollableList);
